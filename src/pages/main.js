  ...
  return (
    <div className={classes.container}>
      <div className={'d-flex'} style={{height: '60%'}}>
        <div className={'w-50 p-4 position-relative'}>
          <h1>OCCUPANCIES:</h1>
          <div className={'position-absolute right-0 h-100 w-100 d-flex align-items-center'}>
            {occupy}
          </div>
        </div>
        ...
        <div className={'w-50 p-4'}>
          <div className={'w-100'}>
            <h1 className={"w-50"}>VACANCIES:</h1>
            <div className={'w-50 d-flex align-items-center'}>
              {vacancy}
            </div>
          </div>
          <div className={'w-100'}>
            <h1 className={"w-50"}>LOAD:</h1>
            <div className={'w-50 d-flex align-items-center'}>
              {load}
            </div>
          </div>
      ...
      <div className={'d-flex flex-grow-1'}>
        {['GALLERIA', 'CANOPY WALK', 'CITY CONE', 'SKY MARKET'].map((data, i) => (
          <div className={'w-25 d-flex flex-column'} key={i}>
            <div className={'text-center'} style={{fontSize: 24, backgroundColor: detailStyles[i].title}}>{data}</div>
